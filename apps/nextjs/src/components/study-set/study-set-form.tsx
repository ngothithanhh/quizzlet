...
const StudySetForm = ({ defaultValues }: StudySetFormProps) => {
  ...
  const create = api.studySet.create.useMutation({
    onSuccess() {
      form.reset({});
      toast.success(`Đã ${defaultValues ? "lưu" : "tạo"} học phần thành công`);
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    placeholder="Ví dụ: Từ vựng Toán học"
                    {...field}
                  />
                </FormControl>
                <FormDescription>Tiêu đề học phần của bạn.</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          ...
          >
            {create.isPending ? (
              ...
              <>{defaultValues ? "Lưu" : "Tạo"} học phần</>
            )}
          </Button>
        </form>
      </Form>
